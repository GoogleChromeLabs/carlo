...
class Window extends EventEmitter {
  ...
  async load(uri = '', ...params) {
    ...
    return new Promise(f => this.domContentLoadedCallback_ = f);
  }
  ...
  async domContentLoaded_() {
    ...
    const { worldId } = await rpc.createWorld(transport, this.loadParams_, this.handle_);
