...
class InterceptedRequest {
   ...
   */
  resourceType() {
     return this.params_.request.resourceType; 
  }
   ...
   * @param {?Object<string, string>} headers HTTP response headers to use.
   * @param {?Buffer} body Response body, content-length is generated if is missing from the |headers|.
   */
  fulfill(statusCode, headers, body) {
